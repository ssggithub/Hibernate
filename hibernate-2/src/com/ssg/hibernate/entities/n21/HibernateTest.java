package com.ssg.hibernate.entities.n21;
...
public class HibernateTest {
	...
	public void testMany2OneSave() {
		...
		/*
		 * session.save(order1); session.save(order2);
		 * 
		 * session.save(customer);
		 */
	}
	...
	public void testMany2OneGet() {
		...
		// 1 的那一端的对象!
		Order order = (Order) session.get(Order.class, 70);
	...
	public void testDelete() {
		// 在不设定级联关系的情况下, 且 1 这一端的对象有 n 的对象在引用, 不能直接删除 1 这一端的对象,发生异常
		Customer customer = (Customer) session.get(Customer.class, 69);
